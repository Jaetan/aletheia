...
[[nodiscard]] auto serialize_parse_dbc(const DbcDefinition& dbc) -> std::string;
[[nodiscard]] auto serialize_parse_dbc_text(std::string_view text) -> std::string;
...
[[nodiscard]] auto serialize_parsed_dbc_response(const DbcDefinition& dbc) -> std::string;
[[nodiscard]] auto serialize_validate_dbc(const DbcDefinition& dbc) -> std::string;
[[nodiscard]] auto serialize_format_dbc_text(const DbcDefinition& dbc) -> std::string;
[[nodiscard]] auto serialize_set_properties(std::span<const LtlFormula> props) -> std::string;
...
[[nodiscard]] auto parse_success(std::string_view input) -> Result<void>;
...
[[nodiscard]] auto parse_event_ack(std::string_view input) -> Result<void>;
[[nodiscard]] auto parse_validation(std::string_view input) -> Result<ValidationResult>;
[[nodiscard]] auto parse_extraction(std::string_view input) -> Result<ExtractionResult>;
[[nodiscard]] auto parse_frame_data(std::string_view input) -> Result<FramePayload>;
[[nodiscard]] auto parse_frame_response(std::string_view input) -> Result<FrameResponse>;
[[nodiscard]] auto parse_stream_result(std::string_view input) -> Result<StreamResult>;
[[nodiscard]] auto parse_dbc_response(std::string_view input) -> Result<DbcDefinition>;
...
[[nodiscard]] auto parse_parsed_dbc(std::string_view input) -> Result<ParsedDBC>;
