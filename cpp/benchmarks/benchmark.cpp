...
static auto make_can20_dbc() -> DbcDefinition {
    ...
    DbcSignal engine_speed{
        ...
        .is_signed = false,
        .factor = ScaleFactor{0.25},
        .offset = ScaleOffset{0.0},
        .minimum = PhysicalValue{0.0},
        .maximum = PhysicalValue{8000.0},
        .unit = Unit{"rpm"},
...
static auto make_canfd_dbc() -> DbcDefinition {
    ...
    auto sig = [](const char* name, std::uint16_t start, std::uint8_t len, bool is_signed,
        ...
        return DbcSignal{
            ...
            .minimum = PhysicalValue{min_val},
            .maximum = PhysicalValue{max_val},
            .unit = Unit{unit},
            .presence = AlwaysPresent{},
        };
    };
