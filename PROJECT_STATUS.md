...
**Status**: Complete (14/14 items + post-implementation review round + post-commit regression fix + Path G three-valued finalisation + review rounds 6-14, all spec observations resolved or deferred with memory)
