...
**Status**: CLI parity ✅ done (PR #21, 2026-06-12) + toolchain bump ✅ no-op.  Remaining (Rust/Haskell bindings, python-can replacement, GHC `--bignum=native`, SOME/IP) not started.  Goal-set locked 2026-05-07.
