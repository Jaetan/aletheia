...
// --- Enrichment: Formula Pretty-Printing ---
...
func TestFormatFormula_MetricAlways(t *testing.T) {
	f := aletheia.MetricAlways{
		Bound: aletheia.Timestamp{Microseconds: 5000000},
...
func TestFormatFormula_MetricEventually(t *testing.T) {
	f := aletheia.MetricEventually{
		Bound: aletheia.Timestamp{Microseconds: 2000000},
...
func TestBuildDiagnostic_AlwaysSucceeds(t *testing.T) {
	formulas := []aletheia.Formula{
		...
		aletheia.MetricAlways{Bound: aletheia.Timestamp{Microseconds: 1000000}, Inner: aletheia.Atomic{Predicate: aletheia.LessThan{Signal: "S", Value: 1}}},
		aletheia.MetricEventually{Bound: aletheia.Timestamp{Microseconds: 1000000}, Inner: aletheia.Atomic{Predicate: aletheia.LessThan{Signal: "S", Value: 1}}},
		aletheia.MetricUntil{Bound: aletheia.Timestamp{Microseconds: 1000000}, Left: aletheia.Atomic{Predicate: aletheia.LessThan{Signal: "A", Value: 1}}, Right: aletheia.Atomic{Predicate: aletheia.GreaterThan{Signal: "B", Value: 2}}},
		aletheia.MetricRelease{Bound: aletheia.Timestamp{Microseconds: 1000000}, Left: aletheia.Atomic{Predicate: aletheia.LessThan{Signal: "A", Value: 1}}, Right: aletheia.Atomic{Predicate: aletheia.GreaterThan{Signal: "B", Value: 2}}},
	}
...
// --- Enrichment: SetProperties auto-derives diagnostics ---
...
// --- Enrichment: SendFrame enriches violations ---
...
func TestEndStream_Enriched(t *testing.T) {
	...
	if !strings.Contains(pr.Enrichment.EnrichedReason, "violated:") {
		t.Errorf("EnrichedReason = %q, want 'violated:' prefix", pr.Enrichment.EnrichedReason)
	}
}
