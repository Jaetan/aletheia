...
C-family files, Go files and the Go module files: // and /* */ comments. Hash-comment files (cmake, yaml, txt,
...
def count(path: Path) -> tuple[int, int, int]:
    ...
    in_block = False
    c_style = path.suffix in C_EXT or path.name in C_NAMES
