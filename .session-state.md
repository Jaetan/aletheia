...
2. **Full formal proofs**: The mechanical inductive proofs for buildFrame-non-corruption could be written but are lengthy; the key insight (disjointness from DBCValid) is established
