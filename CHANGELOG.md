...
- **The benchmark runner tells every binding how much to warm before timing latency.**
  ...
  caller who passed it elsewhere: `--warmup` is refused for any mode but latency,
  where it reached nothing, the other modes warming in whole runs of the frame set.
