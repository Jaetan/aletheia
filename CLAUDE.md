...
**✅ GATE-SOUNDNESS + IWYU + COMMENT-QUALITY ARC ✅ MERGED 2026-07-16 (#190–#194).** The four-item program (E.2 adversary review → UPD → §G.2 → §G.1) + two follow-ups it spawned, all squash-merged to `main`:
