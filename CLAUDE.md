...
**Current track:** Phase B.3 ✅ COMPLETE 2026-05-03 on branch `b3d-3d5-format-dsl` — verified Agda DBC text parser bound across all three bindings; cantools dropped from runtime.
