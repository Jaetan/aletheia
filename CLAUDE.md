...
**Next pre-close items**: (1) `Assign.agda` 18 `ModuleDoesntExport` warnings (in-source block `Properties/Attributes/Assign.agda:35-65`); (2) review-process meta-review (user directive 2026-05-20; `memory/feedback_review_process_revisit.md`).  AGDA-A-1.1 + AGDA-D-12.1 both closed.  **Push gap**: local `main` 161+ commits ahead of `origin/main` — R20+R21 merges + R22 work held local per `feedback_review_branch_workflow.md`.
