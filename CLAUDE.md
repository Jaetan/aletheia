...
**Layer 3 status post-3d.5.d-BU_**: BO_ block ✅ closed; ValueTable ✅; BU_ ✅.  Remaining pending: 3d.5.d migrations of 3a (Preamble) + 3b (EV_, CM_) + 3c (BA_DEF_ family) onto DSL → Layer 4 (parseDBC aggregator).
