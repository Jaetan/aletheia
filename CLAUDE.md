...
**Current track:** Phase D ⏳ in_progress on branch `b3d-3d5-format-dsl` — cross-binding doc-example harness (R17-DEF-6). **D.2 (Go) ✅ COMPLETE 2026-05-04** (`d0ae26b`); **D.1 (C++ catch2 mirror) pending** — only remaining R17-DEF-6 piece.
