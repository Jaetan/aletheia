...
open import Aletheia.CAN.Endianness using (ByteOrder; LittleEndian; BigEndian; extractBits; injectBits; swapBytes; injectPayload; payloadIso; physicalBitPos; not-in-interval)
open import Aletheia.CAN.Endianness.Properties using (extractBits-injectBits-roundtrip; swapBytes-involutive; payloadIso-involutive; injectBits-preserves-disjoint; injectBits-preserves-outside; physicalBitPos-BE-involutive; extractBits-swap-inject-preserves)
...
-- ============================================================================
-- DISJOINT BIT PRESERVATION (moved from Encoding.agda)
-- ============================================================================
