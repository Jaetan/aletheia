...
class ErrorCode(StrEnum):
    ...
    PARSE_SIGNAL_START_BIT_EXCEEDS_FRAME = "parse_signal_start_bit_exceeds_frame"
    PARSE_SIGNAL_BIT_LENGTH_EXCEEDS_FRAME = "parse_signal_bit_length_exceeds_frame"
    PARSE_SIGNAL_BIG_ENDIAN_OVERFLOW = "parse_signal_big_endian_overflow"
