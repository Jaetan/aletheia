...
class TestSignalComparison:
    ...
    def test_greater_than(self) -> None:
        ...
        assert formula == {
            "operator": "atomic",
            "predicate": {"predicate": "greaterThan", "signal": "Speed", "value": 5},
        }
    ...
    def test_less_than_or_equal(self) -> None:
        ...
        assert formula == {
            "operator": "atomic",
            "predicate": {"predicate": "lessThanOrEqual", "signal": "Voltage", "value": 14.5},
        }
    ...
    def test_greater_than_or_equal(self) -> None:
        ...
        assert formula == {
            "operator": "atomic",
            "predicate": {"predicate": "greaterThanOrEqual", "signal": "Voltage", "value": 11.5},
        }
    ...
    def test_changed_by(self) -> None:
        ...
        assert formula == {
            "operator": "atomic",
            "predicate": {"predicate": "changedBy", "signal": "Speed", "delta": -10},
        }
