        ...
        "messages": [
            {
                ...
                "signals": [
                    DBCSignalAlways(
                        ...
                        signed=False,
                        factor=to_signal_fraction(1),
                        offset=to_signal_fraction(0),
                        minimum=to_signal_fraction(0),
                        maximum=to_signal_fraction(255),
                        unit="",
                        presence="always",
                    ),
                    DBCSignalMultiplexed(
                        ...
                        byteOrder="little_endian",
                        signed=True,
                        factor=to_signal_fraction(0.1),
                        offset=to_signal_fraction(-40),
                        minimum=to_signal_fraction(-40),
                        maximum=to_signal_fraction(215),
                        unit="degC",
                    ...
                    DBCSignalMultiplexed(
                        ...
                        byteOrder="little_endian",
                        signed=False,
                        factor=to_signal_fraction(0.01),
                        offset=to_signal_fraction(0),
                        minimum=to_signal_fraction(0),
                        maximum=to_signal_fraction(655),
                        unit="bar",
                        presence="multiplexed",
                        multiplexor="MuxSelector",
                        multiplex_values=[1],
        ...
        "messages": [
            {
                ...
                "signals": [
                    DBCSignalAlways(
                        ...
                        offset=to_signal_fraction(0),
                        minimum=to_signal_fraction(0),
                        maximum=to_signal_fraction(300),
                        unit="km/h",
                        presence="always",
                    ),
                ],
